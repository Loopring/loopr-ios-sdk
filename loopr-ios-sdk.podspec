#
#  Be sure to run `pod spec lint loopr-ios-sdk.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.license      = { :type => "GNU General Public License v3.0", :file => "FILE_LICENSE" }
  ...
  s.author             = { "loopring" => "foundation@loopring.org" }
  ...
  s.source       = { :git => "https://github.com/Loopring/loopr-ios-sdk.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "loopr-ios-sdk/**/*.{swift}"
